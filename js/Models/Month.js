function Month(monthNumber,yearNumber)
{
    ...
    var year                    = yearNumber;
    var month_of_year           = monthNumber;
    var month_titles            = ["January","February","March","April",
                                "May","June","July","August",
                                "September","October","November","December"];
    var current_month_title     = month_titles[monthNumber];

    //number of days in current month
    var number_of_days          = new Date(yearNumber,(monthNumber+1),0); //monthNumber starts at 0 this does not
    number_of_days          =number_of_days.getDate();

    //Number of first day of month (0-6 : sun-sat)
    var first_day_of_month      = new Date(yearNumber,(monthNumber),1);
